...
const ContactPage = () => {
    ...
    return (
            ...
            <section className="container mx-auto px-4 py-16">
                <h1 className="text-3xl md:text-5xl font-bold mb-12 text-center">Contact Me!</h1>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">chris.mendes@example.com</p>
                                </div>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full flex justify-center items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium"
                            >
                                <Send size={18} />
                                Submit
                            </button>
